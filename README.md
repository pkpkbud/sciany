...
- [Mam kilka programów **ABC** na kluczu USB](https://github.com/pkpkbud/sciany/releases/download/4.0.2/Sciany-ABC6-4.0.2-win32.msi)
- [Mam tylko **ABC Płyta** na kluczu USB](https://github.com/pkpkbud/sciany/releases/download/4.0.2/Sciany-ABC6p-4.0.2-win32.msi)
- [Mam tylko **ABC Tarcza** na kluczu USB](https://github.com/pkpkbud/sciany/releases/download/4.0.2/Sciany-ABC6t-4.0.2-win32.msi)
- [Mam tylko **ABC Obiekt3D** na kluczu USB](https://github.com/pkpkbud/sciany/releases/download/4.0.2/Sciany-ABC6s-4.0.2-win32.msi)
